...
<body>
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/blue_eye.png" alt="">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      The amount of sugar or glucose present in the blood of an individual, and it is used to diagnose diabetes, and it is performed at any time during the day, and the individual does not need to fast when performing                    <div>
                      <a href="service.php">
                        Visit Our Service
                      </a>
                    </div>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/knowldge.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      You can find so many useful information about DRD and ....
                    </p>
                    <div>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="img-box">
        <img style="width:50%;" src="images/about.jpg" alt="">
      </div>
      <div class="detail-box">
        <p>
